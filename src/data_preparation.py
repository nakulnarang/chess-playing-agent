...
from common.utils import state_to_2d_array, move_to_square_indices
...
def download_pgn(num_games=100, max_rating=2000):
    ...
    """
    url = f"https://lichess.org/api/games/user/DrNykterstein?max={num_games}&rated=true&perfType=rapid"
    ...
    if not os.path.exists(output_file):
        ...
        curl_command = f'curl -v -H "Accept: application/x-chess-pgn" "{url}" -o "{output_file}"'
